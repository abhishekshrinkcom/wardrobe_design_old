			...
			<div class="col-md-12">
				<div class="form-outer">
					<form action="#">
						...
						<div class="page">
							<div class="title">FOLDING THE INTERIOR:</div>
									...
									<div class="accordion" id="accordionDoor">
										<div class="border-bottom card mb-2">
											<div class="card-header" id="doorOne" data-toggle="collapse" data-target="#collapseDoor1" aria-expanded="true" aria-controls="collapseDoor1">
												<h4 class="mb-0">Long hanging</h4>
											</div>

											<div id="collapseDoor1" class="collapse" aria-labelledby="doorOne" data-parent="#accordionDoor">
												<div class="card-body">
													<div class="radio-with-Icon">
														<p class="radioOption-Item">
															...
															<label for="door1_1">
																<img src="assets/img_web/Long_hanging1.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_2">
																<img src="assets/img_web/gsh2.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_3">
																<img src="assets/img_web/gsh3.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_4">
																<img src="assets/img_web/gsh4.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_5">
																<img src="assets/img_web/gsh5.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_6">
																<img src="assets/img_web/gsh8.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_7">
																<img src="assets/img_web/gsh11.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_8">
																<img src="assets/img_web/gsh12.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_9">
																<img src="assets/img_web/gsh14.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_10">
																<img src="assets/img_web/gsv1.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_11">
																<img src="assets/img_web/gsv3.png" alt="" class="select_imgs">
															</label>
														</p>
														<p class="radioOption-Item">
															...
															<label for="door1_12">
																<img src="assets/img_web/gsv4.png" alt="" class="select_imgs">
															</label>
														</p>
													</div>
												</div>
										...
										<div class="border-bottom card mb-2">
											<div class="card-header" id="doorTwo" data-toggle="collapse" data-target="#collapseDoor2" aria-expanded="false" aria-controls="collapseDoor2">
												<h4 class="mb-0">Short suspension</h4>
											</div>
										...
										<div class="border-bottom card mb-2">
											<div class="card-header" id="doorThree" data-toggle="collapse" data-target="#collapseDoor3" aria-expanded="false" aria-controls="collapseDoor3">
												<h4 class="mb-0">Combined suspension</h4>
											</div>
						...
						<div class="page">
							<div class="title mb-4">CHOOSING THE COLOR OF THE DECOR FOR THE INSIDE OF THE BUILT-IN CABINET</div>
							<div class="align-items-center d-flex justify-content-center">
								<div class="bg_image_ch">
									<img src="assets/img_web/hand-click.png" alt="" class="border btn-default btn" data-toggle="modal" data-target="#woodColor">
								</div>
							</div>
						...
						<div class="page">
							<div class="title mb-4">CHOOSING THE COLOR OF THE DECOR FOR THE VISIBLE PARTS OF THE BUILT-IN CABINET</div>
							<div class="align-items-center d-flex justify-content-center">
								<div class="bg_image_ch2">
									<img src="assets/img_web/hand-click.png" alt="" class="border btn-default btn" data-toggle="modal" data-target="#visible_parts">
								</div>
							</div>
						...
						<div class="page">
							<div class="title mb-4">CHOOSING THE DOOR TYPE</div>
							<div class="row">
								<div class="col-md-6">
									<table class="grid_center">
										<tr>
								...
								<div class="col-md-6">
									<div class="accordion" id="accordionDoorType">
										<div class="border-bottom card mb-2">
											<div class="card-header" id="doorOne" data-toggle="collapse" data-target="#collapseDoor1" aria-expanded="true" aria-controls="collapseDoor1">
												<h4 class="mb-0">List of door types</h4>
											</div>

											<div id="collapseDoor1" class="collapse" aria-labelledby="doorOne" data-parent="#accordionDoorType">
												<div class="card-body">
													<div class="radio-with-Icon">
														<p class="radioOption-Item">
															<input type="radio" name="doorPanel1" id="door1_1" value="true" class="ng-valid ng-dirty ng-touched ng-empty" aria-invalid="false" style="">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/ST9_Vanilla_yellow.jpg" alt="" class="w-h-252 inside_clr">
						</div>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/ST22_Fineline_cream.jpg" alt="" class="w-h-252 inside_clr">
						</div>
						<div class="px-2 border">
							<small>1424H</small>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/ST9_Birch_Mainau.jpg" alt="" class="w-h-252 inside_clr">
						</div>
						<div class="px-2 border">
							<small>1733H</small>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/K080_White_Oak.jpg" alt="" class="w-h-252 inside_clr">
						</div>
						<div class="px-2 border">
							<small>K080</small>
							<h5>White Oak</h5>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/Ceresňa.jpg" alt="" class="w-h-252 inside_clr2">
						</div>
						<div class="px-2 border">
							<small>0344 PR</small>
							<h5>Ceresňa</h5>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/Maple.jpg" alt="" class="w-h-252 inside_clr2">
						</div>
						<div class="px-2 border">
							<small>0375 PR</small>
							<h5>Maple</h5>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/Beech_Bavaria.jpg" alt="" class="w-h-252 inside_clr2">
						</div>
						<div class="px-2 border">
							<small>0381 PR</small>
							<h5>Beech Bavaria</h5>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/ST_9_Limetková.jpg" alt="" class="w-h-252 inside_clr2">
						</div>
						<div class="px-2 border">
							<small>0630 U</small>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/ST22_Whitewood.jpg" alt="" class="w-h-252 inside_clr2">
						</div>
						<div class="px-2 border">
							<small>1122H</small>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/ST12_Black_brown_Sorano_oak.jpg" alt="" class="w-h-252 inside_clr2">
						</div>
						<div class="px-2 border">
							<small>1137H</small>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/ST10_Bardolino_oak_natural.jpg" alt="" class="w-h-252 inside_clr2">
						</div>
						<div class="px-2 border">
							<small>1145H</small>
					...
					<div class="col-md-3 mb-3 color_fill_ins" data-dismiss="modal" aria-label="Close">
						<div class="border">
							<img src="assets/img_web/ST36_Navarra_Ash.jpg" alt="" class="w-h-252 inside_clr2">
						</div>
						<div class="px-2 border">
							<small>1250H</small>
