				...
				<div class="row">
					<div class="col-md-6 mb-2">
						<div class="card p-2 single-slider-post">
							<!-- <h4 class="post-title text-center"><a href="Javascript:void(0)">Type A - Floor plan</a></h4> -->
							<div class="row">
								<div class="col-md-12">
								...
								<!-- <div class="col-md-6">
									<div class="single-slider-post__content">
										<p class="post-excerpt">The cabinet will be from the left wall to the right. <br><b><i>note:</i></b><i>the length of the interior will be - 1cm</i></p>
									</div>
								</div> -->
							</div>
						</div>
					...
					<div class="col-md-6 mb-2">
						<div class="card p-2 single-slider-post">
							<!-- <h4 class="post-title text-center"><a href="Javascript:void(0)">Type B - Floor plan</a></h4> -->
							<div class="row">
								<div class="col-md-12">
									<div class="single-slider-post__image mb-30">
										<a href="javascript:void(0)" id="plan_type_A">
					...
					<div class="col-md-6 mb-2">
						<div class="card p-2 single-slider-post">
							<!-- <h4 class="post-title text-center"><a href="Javascript:void(0)">Type C - Floor plan</a></h4> -->
							<div class="row">
								<div class="col-md-12">
									<div class="single-slider-post__image mb-30">
										<a href="javascript:void(0)" id="plan_type_A">
					...
					<div class="col-md-6 mb-2">
						<div class="card p-2 single-slider-post">
							<!-- <h4 class="post-title text-center"><a href="Javascript:void(0)">Type D - Floor plan</a></h4> -->
							<div class="row">
								<div class="col-md-12">
									<div class="single-slider-post__image mb-30">
										<a href="javascript:void(0)" id="plan_type_A">
					...
					<form action="#" class="">
						<div class="row">
							<div class="col-md-3 d-flex flex-column justify-content-center">
								...
								<input type="text" placeholder="" required="" id="" class="w-100 para_lfh2"> in cm
							</div>
							<div class="col-md-6">
								<img src="assets/img_web/box1.png" class="img-fluid w-100" alt="">
								<div class="depth1 form-inline">
									<label>Depth</label>
									<input type="text" placeholder="" required="" id="" class="border-0 para_depth2"> in cm
								</div>
								<div class="text-center">
									<label>Width</label>
									<input type="text" placeholder="width" id="" required="" class="para_width2"> in cm
								</div>
							</div>
							<div class="col-md-3 d-flex flex-column justify-content-center">
								<label>Right height</label>
								<input type="text" placeholder="" required="" id="" class="w-100 para_rfh2"> in cm
							</div>
						</div>
					</form>
				</div>
...
<div class="product-category-container mb-md-90 mb-sm-90">
	<div class="container wide">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-12 max_h505">
				<div class="row">
					<div class="col-md-2">
